---
name: YouTube learning materials
description: Product and access-control decisions for YouTube-backed learning resources.
---

## Rule
Treat YouTube videos as provider-hosted LMS resources, storing their metadata alongside existing materials. The LMS must gate the resource page by its visibility rules, but an unlisted YouTube URL is not a substitute for strict content protection.
