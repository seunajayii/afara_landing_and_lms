...
**How to apply:** Probe storage before background reconciliation, keep private playback and learner resource files behind application authorization routes, and ask for bucket provisioning when uploads are unavailable. Never encode ordinary uploaded files into database text fields as a storage fallback.
